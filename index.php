...
<div id="pagewrap">
	...
	<header id="header">
		...
		<nav>
			<ul id="main-nav" class="clearfix">
				<li><a onclick="DarDeAlta()" class="btn">Alta</a></li>
				<li><a onclick="Ingreso()" class="btn">Ingreso</a> </li>
				<li><a onclick="MiPerfil()" class="btn">Mi Perfil</a> </li>
				<li><a onclick="Grilla()" class="btn">Grilla</a> </li>
			</ul>
			<!-- /#main-nav --> 
		</nav>
	...
	<div id="content" >
		...
		<article  class="post clearfix">
			...
			<header  >
				<h1 class="post-title"><a href="#">Sanchez.Guillermo</a></h1>
